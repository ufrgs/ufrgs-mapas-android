...
/**
 *  Class override to implement remove operations. As implemented by Viachaslau Tysianchuk here:
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    public static final int MAX_DISTANCE_AT_ZOOM = 70; // dp.
    ...
    private Bounds createBoundsFromSpan(Point p, double span) {
        // TO-DO: Use a span that takes into account the visual size of the marker, not just its
        // LatLng.
